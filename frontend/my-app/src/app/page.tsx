                  ...
                  <tr key={`${machine.id}-${machine.preventiveTypeId || index}`}>
                    ...
                    <td className="text-center pe-4">
                      <div className="btn-group shadow-sm" role="group">
                        <Link href={`/pm/inspect/${machine.id}${machine.preventiveTypeId ? `?typeId=${machine.preventiveTypeId}&returnTo=/` : '?returnTo=/'}`} className="btn btn-sm btn-outline-primary">
                          <i className="bi bi-clipboard-check"></i> Inspect
                        </Link>
